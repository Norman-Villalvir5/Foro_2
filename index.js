...
const ObtenerAlumno = () => db.collection('Alumno').get();
const ActualizarAlumno = (callback) => db.collection('Alumno').onSnapshot(callback);
const EliminarAlumno = id => db.collection('Alumno').doc(id).delete();
const EditarAlumno = (id) => db.collection('Alumno').doc(id).get();
const ActulalizarTodo = (id, updatedTask) => db.collection('Alumno').doc(id).update(updatedTask);
